...
while (guessesNumber) {
  if (visitorNumber === undefined) {
    visitorNumber = parseInt(prompt(`${guessesNumber} try left! Guess a number:`, ''), 10);
    guessesNumber--;
  }
  ...
  if (visitorNumber < myNumber) {
    ...
    visitorNumber = parseInt(prompt(`Hint: Higher!\n\n${guessesNumber} try left!\n\nGuess a number:`, ''), 10);
    guessesNumber--;
  }
  if (visitorNumber > myNumber){
    // console.log('Hint: Lower');
    visitorNumber = parseInt(prompt(`Hint: Lower!\n\n${guessesNumber} try left!\n\nGuess a number:`, ''), 10);
    guessesNumber--;
  }
}
